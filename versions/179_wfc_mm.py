            ...
            if((not (i==0 and j==0)) and (i==0 or j==0)):
                if(x+i>=0 and x+i<size and y+j>=0 and y+j<size):
                    if wo[x+i][y+j].collapsed=="none":
                        if current=="mountain":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"mountain":17,"hills":9,"coast":1,"ocean":1,"sand":2,"dunes":2,"deepwood":7,"forest":7})
                            ...
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"forest":6,"trees":3,"deepWood":3,"lake":2,"hills":4,"mountain":4,"jungle":1})
                        elif current == "deepWood":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"deepWood":2,"forest":1,"mountain":1})
                        elif current == "hills":
