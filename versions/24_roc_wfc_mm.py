                ...
                if(x+i>=0 and x+i<size and y+j>=0 and y+j<size):
                    if wo[x+i][y+j].collapsed=="none":
                        if current=="mountain":
                            ...
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"grassland":7,"hills":2,"sand":2,"trees":2,"swamp":2,"coast":1})
                        elif current == "sand":
                            ...
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"trees":7,"grassland":3,"forest":5})
                        elif current == "forest":
...
if __name__=="__main__":
    ...
    for i in range(3*int(math.sqrt(magnitude))):
