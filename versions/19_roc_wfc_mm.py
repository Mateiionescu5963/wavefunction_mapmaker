            ...
            if((not (i==0 and j==0)) and (i==0 or j==0)):
                if(x+i>=0 and x+i<size and y+j>=0 and y+j<size):
                    if wo[x+i][y+j].collapsed=="none":
                        if current=="mountain":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"mountain":14,"hills":3,"coast":2,"sand":0,"dunes":0})
                        elif current == "grassland":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"grassland":14,"hills":2,"sand":2,"trees":2,"swamp":2,"lake":2,"coast":2})
                        elif current == "sand":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"sand":14,"grassland":3,"dunes":0,"coast":3,"mountain":2})
                        elif current == "dunes":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"dunes":14,"sand":3,"mountain":2})
                        elif current == "trees":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"trees":14,"grassland":3,"forest":5,"lake":2})
                        elif current == "forest":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"forest":14,"trees":3,"deepWood":3,"lake":2,"hills":2})
                        elif current == "deepWood":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"deepWood":14,"forest":4,"hills":0})
                        elif current == "hills":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"hills":14,"mountain":0,"grassland":3,"trees":3})
                        elif current == "swamp":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"swamp":14,"grassland":1,"coast":3})
                        elif current == "lake":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"lake":14,"trees":1,"grassland":1,"forest":1})
                        elif current == "coast":
