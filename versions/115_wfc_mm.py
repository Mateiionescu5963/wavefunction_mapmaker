            ...
            if((not (i==0 and j==0)) and (i==0 or j==0)):
                if(x+i>=0 and x+i<size and y+j>=0 and y+j<size):
                    if wo[x+i][y+j].collapsed=="none":
                        if current=="mountain":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"mountain":10,"hills":4,"coast":1,"ocean":1,"sand":2,"dunes":2,"grassland":6,"trees":6})
                        elif current == "grassland":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"grassland":15,"hills":1,"sand":1,"trees":4,"swamp":2,"lake":2,"tundra":1,"coast":21,"jungle":2,"mountain":10})
                        elif current == "sand":
                            ...
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"trees":15,"grassland":4,"forest":6,"tundra":2,"lake":3,"mountain":11})
                        elif current == "forest":
                            ...
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"ocean":19,"coast":8,"deepOcean":1,"seaIce":10,"mountain":6})
