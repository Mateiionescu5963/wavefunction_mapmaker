                ...
                if(x+i>=0 and x+i<size and y+j>=0 and y+j<size):
                    if wo[x+i][y+j].collapsed=="none":
                        if current=="mountain":
                            ...
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"sand":10,"grassland":3,"dunes":5,"coast":10,"mountain":2})
                        elif current == "dunes":
                            ...
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"coast":10,"sand":3,"swamp":4,"mountain":8,"tundra":3,"ocean":2,"grassland":8,"seaIce":1})
                        elif current == "ocean":
