                ...
                if(x+i>=0 and x+i<size and y+j>=0 and y+j<size):
                    if wo[x+i][y+j].collapsed=="none":
                        if current == "grassland":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"grassland":15,"hills":1,"trees":4,"coast":21})
                        elif current == "trees":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"trees":8,"grassland":4,"forest":6})
                        elif current == "forest":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"forest":6,"trees":3,"deepWood":3,"hills":4})
                        elif current == "deepWood":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"deepWood":2,"forest":1,"hills":1})
                        elif current == "hills":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"hills":4,"grassland":9,"trees":9})
                        elif current == "coast":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"coast":10,"ocean":2,"grassland":18,"seaIce":1})
                        elif current == "ocean":
        ...
        for j in range(-1,2):
            if((not (i==0 and j==0)) and (i==0 or j==0)):
                if(x+i>=0 and x+i<size and y+j>=0 and y+j<size):
                    if wo[x+i][y+j].collapsed=="none":
                        if current=="mountain":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"mountain":9,"hills":7,"coast":4,"dunes":4,"forest":2,"deepWood":0})
                        elif current == "grassland":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"grassland":10,"hills":10 ,"coast":10 ,"swamp":5 ,"trees":10, "lake":3})
                        elif current == "sand":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"sand":4,"coast":0,"dunes":4,"lake":0})
                        elif current == "dunes":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"dunes":7,"sand":7,"mountain":5})
                        elif current == "trees":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"trees":4,"forest":4,"grassland":0,"hills":0,"lake":1})
                        elif current == "forest":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"forest":6,"trees":3,"deepWood":5,"mountain":0,"lake":1,"hills":0})
                        elif current == "deepWood":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"deepWood":6,"forest":4,"mountain":0,"lake":0})
                        elif current == "hills":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"hills":6,"mountain":0,"grassland":4,"trees":4,"forest":4})
                        elif current == "coast":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"coast":200,"grassland":80,"trees":80,"sand":80,"mountain":20,"ocean":0,"swamp":40})
                        elif current == "ocean":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"ocean":200,"coast":150})
                        elif current == "swamp":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"swamp":4,"coast":0,"grassland":1})
                        elif current == "lake":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"lake":3,"forest":0,"deepWood":0,"grassland":1,"sand":1,"trees":0})
                        else:
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"all":0})
...
def secondRun(theWorld,magnitude):
    ...
    for i in range(magnitude):
        for j in range(magnitude):
            if theWorld[i][j].collapsed in land:
                theWorld[i][j].collapsed="none"
                
    
    for i in range(magnitude):
        for j in range(magnitude):
            if not theWorld[i][j].collapsed=="none":
                theWorld=updateSecondary(theWorld,i,j,magnitude)
    ...
    while(True):
        ...
        theWorld[r1][r2]=collapse(theWorld[r1][r2])
        theWorld = updateSecondary(theWorld,r1,r2,magnitude)
...
if __name__=="__main__":
    ...
    f = open("doublePass_concatenationAttempt.py","r")
    thisFile = f.read()
    f.close()
    
    f = open("./"+name+"_dpca_wfc_mm.py","w")
    f.write(thisFile)
    f.close()
    ...
    for i in range(magnitude):
        for j in [0,1]:
            theWorld[j][i].collapsed="ocean"
            theWorld[i][j].collapsed="ocean"
            theWorld[magnitude-j-1][i].collapsed="ocean"
            theWorld[i][magnitude-j-1].collapsed="ocean"
