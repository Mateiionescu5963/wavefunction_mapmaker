                ...
                if(x+i>=0 and x+i<size and y+j>=0 and y+j<size):
                    if wo[x+i][y+j].collapsed=="none":
                        if current=="mountain":
                            ...
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"grassland":14,"hills":4,"sand":3,"trees":4,"swamp":4,"coast":1})
                        elif current == "sand":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"sand":3,"grassland":3,"dunes":0,"coast":1,"mountain":0})
                        elif current == "dunes":
