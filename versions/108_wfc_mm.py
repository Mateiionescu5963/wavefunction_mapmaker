                ...
                if(x+i>=0 and x+i<size and y+j>=0 and y+j<size):
                    if wo[x+i][y+j].collapsed=="none":
                        if current=="mountain":
                            ...
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"sand":10,"grassland":5,"dunes":5,"coast":10,"mountain":5})
                        elif current == "dunes":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"dunes":9,"sand":7,"mountain":2})
                        elif current == "trees":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"trees":7,"grassland":5,"forest":4,"tundra":2,"lake":3})
                        elif current == "forest":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"forest":6,"trees":4,"deepWood":3})
                        elif current == "deepWood":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"deepWood":2,"forest":1})
                        elif current == "hills":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"hills":6,"mountain":8,"grassland":2,"trees":3,"tundra":1})
                        elif current == "coast":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"coast":18,"sand":3,"swamp":4,"mountain":8,"tundra":3,"ocean":2,"grassland":8,"seaIce":1})
                        elif current == "ocean":
