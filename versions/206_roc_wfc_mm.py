            ...
            if((not (i==0 and j==0)) and (i==0 or j==0)):
                if(x+i>=0 and x+i<size and y+j>=0 and y+j<size):
                    if wo[x+i][y+j].collapsed=="none":
                        if current=="mountain":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"mountain":10,"hills":4,"coast":1,"sand":0,"dunes":3})
                        elif current == "grassland":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"grassland":10,"hills":4,"sand":3,"trees":4,"swamp":4,"coast":1})
                        elif current == "sand":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"sand":10,"grassland":3,"dunes":0,"coast":1,"mountain":0})
                        elif current == "dunes":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"dunes":10,"sand":3,"mountain":0})
                        elif current == "trees":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"trees":10,"grassland":4,"forest":6})
                        elif current == "forest":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"forest":10,"trees":3,"deepWood":3,"hills":2})
                        elif current == "deepWood":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"deepWood":10,"forest":4,"hills":0})
                        elif current == "hills":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"hills":10,"mountain":0,"grassland":3,"trees":3})
                        elif current == "swamp":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"swamp":10,"grassland":0,"coast":4})
                        elif current == "coast":
