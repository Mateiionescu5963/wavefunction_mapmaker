                ...
                if(x+i>=0 and x+i<size and y+j>=0 and y+j<size):
                    if wo[x+i][y+j].collapsed=="none":
                        if current=="mountain":
                            ...
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"swamp":7,"grassland":0,"coast":5})
                        elif current == "coast":
                            wo[x+i][y+j]=single_update(wo[x+i][y+j],{"coast":14,"sand":0,"swamp":0,"mountain":0,"ocean":4,"grassland":0})
                        elif current == "ocean":
...
if __name__=="__main__":
    ...
    for i in range(5*int(int(math.sqrt(magnitude))/8)):
    ...
    try:
        ...
        while(True):
            if len(collapse_next)>0:
                ...
                if it%int(math.sqrt(magnitude))==0:
                    print(">",end="")
                done = False
                for i in range(magnitude):
